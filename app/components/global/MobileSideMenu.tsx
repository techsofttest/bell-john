                                        ...
                                        >
                                            <div className="flex items-center gap-4">
                                                <div className="relative w-12 h-12 rounded-xl overflow-hidden shadow-sm">
                                                    <Image src={cat.image ? (cat.image.startsWith('http') ? cat.image : encodeImageUrl(cat.image, STORAGE_URL)) : 'https://images.unsplash.com/photo-1598520106830-8c45c2035460?q=80&w=600'} alt={cat.name || cat.title || 'Category'} fill className="object-cover" />
                                                </div>
