...
// Mock Data specific to a high-value category
const spotlightProducts = [
    { id: 101, title: "HP Color LaserJet Pro Multifunction Printer", category: "Office Machines", image: "https://images.unsplash.com/photo-1612815154858-60aa4c59eaa6?q=80&w=600" },
    ...
    return (
        <section className="py-20 bg-slate-50 overflow-hidden border-t border-slate-100">
            <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
                ...
                {/* --- Tiered Title & Controls (Link removed from here) --- */}
                <div className="flex justify-between items-end mb-12 gap-6">
                    <div className="space-y-2">
                        <div className="flex items-center gap-3">
                            <span className="w-10 h-[1px] bg-brand"></span>
                            <span className="text-[11px] uppercase tracking-[0.3em] font-bold text-brand">Category Spotlight</span>
                        </div>
