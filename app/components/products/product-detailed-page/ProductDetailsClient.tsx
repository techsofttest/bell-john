...
export default function ProductDetailsClient({ product }: ProductDetailsClientProps) {
    ...
    {/* ==========================================================
        GALLERY SECTION
        ========================================================== */}
    <div className="order-1 lg:order-1 lg:col-span-7 p-5 md:p-8 lg:p-10 rounded-t-3xl lg:rounded-tr-none lg:rounded-l-3xl">
    ...
    {/* ==========================================================
        RIGHT SIDE PANEL
        ========================================================== */}
    <div className="order-2 lg:order-2 lg:col-span-5 bg-slate-50/15 h-full relative lg:rounded-r-3xl">
    ...
    {/* ==========================================================
        OVERVIEW + SPECS
        ========================================================== */}
    <div className="order-3 lg:order-3 lg:col-span-7 p-5 md:p-8 lg:p-10 rounded-b-3xl lg:rounded-bl-3xl">
