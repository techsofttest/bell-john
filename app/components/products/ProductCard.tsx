...
export default function ProductCard({
    ...
    return (
        <div className="group relative flex flex-col bg-white border border-slate-100 rounded-xl overflow-hidden transition-all duration-500 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-slate-200/60 w-full h-full">
            ...
            <Link
                href={`/products/${id}`}
                className="relative h-[160px] md:h-[220px] w-full bg-slate-50 overflow-hidden block"
            >
                <Image
                    src={imgSrc}
                    alt={title}
                ...
                {displayTag && (
                    <div
                        className={`absolute top-2 left-2 md:top-3 md:left-3 z-20 flex items-center gap-0.5 md:gap-1.5 px-1.5 py-0.5 md:px-3 md:py-1.5 rounded-full border shadow-sm ${schemeClasses} group-hover:scale-105 transition-transform duration-300 pointer-events-none`}
                    >
                        {displayTag.icon && (
            ...
            <div className="p-3 md:p-5 flex flex-col flex-grow">
                ...
                <div className="mt-auto">
                    ...
                    >
                        ...
                        <ArrowRight
                            className="w-3.5 h-3.5 md:w-4.5 md:h-4.5 transition-transform duration-500 group-hover/btn:translate-x-2"
                            strokeWidth={3}
                        />
                    </Button>
                </div>
